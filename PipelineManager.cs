...
namespace Vision
{
    ...
    ///       &lt;Steps&gt;
    ///         &lt;Step type="VisionPro.ConvertGray"&gt;&lt;Channel&gt;1&lt;/Channel&gt;&lt;/Step&gt;
    ...
    public class PipelineManager
    {
        ...
        /// <summary>
        /// 현재 활성 파이프라인 설정. 목록이 비어 있거나 인덱스 범위를 벗어나면 null을 반환합니다.
        /// </summary>
        ...
        /// <summary>
        /// 활성 파이프라인의 인덱스. 0 이상, Configs.Count-1 이하로 자동 클램핑됩니다.
        /// </summary>
        ...
        /// <summary>
        /// 새 파이프라인 설정을 목록 끝에 추가하고 활성 인덱스를 해당 항목으로 이동합니다.
        /// </summary>
        ...
        /// <summary>
        /// 지정 인덱스의 파이프라인을 목록에서 제거합니다.
        /// 활성 인덱스가 범위를 벗어나지 않도록 자동 조정합니다.
        /// </summary>
        ...
        /// <summary>
        /// 현재 관리 중인 모든 파이프라인을 XML 파일로 저장합니다.
        ///
        /// 각 스텝이 IStepSerializable을 구현하면 SaveParams()를 호출하여
        /// 스텝별 파라미터(Region, RunParams 등)를 &lt;Step&gt; 요소에 기록합니다.
        ...
        /// <summary>
        /// XML 파일에서 파이프라인 설정을 로드합니다.
        ///
        /// 스텝 생성은 외부에서 제공한 stepFactories 딕셔너리를 통해 수행합니다.
        /// 이를 통해 Vision.dll은 GUI 어셈블리(StepDescriptor 등)에 의존하지 않습니다.
        ///
        /// XML에 기록된 type 속성으로 팩토리를 조회하고, 팩토리가 없는 스텝은 건너뜁니다.
        /// 각 스텝이 IStepSerializable을 구현하면 LoadParams()를 호출하여 파라미터를 복원합니다.
        /// XML 파일이 없으면 아무 작업도 수행하지 않습니다.
        /// </summary>
